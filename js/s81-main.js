var app = new Vue({
	...
	methods: {
		...
		onScrollTop() {
			...
			var oWideAngleCanvas = document.querySelector(".s81-wideAngle");
			...
			function setScrollTop() {
				...
				if (_this.mouseDirect) {
					...
					} else if (windowScrollTop >= (oBezel_lessCanvas.offsetTop + oBezel_lessCanvas.offsetHeight + _this.window_height /
							2)) {
						n1 = 0;
						n2 = 0;
				...
				if (e == 0 && windowScrollTop > oWideAngleCanvas.offsetTop + _this.window_height / 2 >
					0) {
